				...
				<div class="wppfm-discount-promotion-container">
					...
					<div class="wppfm-discount-promotion-offer">
						<div class="wppfm-discount-promotion-message">
							<h1>' . esc_html__( '50% Black Friday SALE!!', 'wp-product-feed-manager' ) . '</h1><p>' . esc_html__( 'Black Friday Sale: 50% Off', 'wp-product-feed-manager' ) . ' <em>Google Feed Manager Premium!</em> ' . esc_html__( 'From November 25 to December 8, 2024.', 'wp-product-feed-manager' )
