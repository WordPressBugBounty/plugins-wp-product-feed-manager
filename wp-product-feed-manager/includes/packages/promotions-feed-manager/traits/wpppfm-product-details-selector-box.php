	...
	protected static function content_box( $promotion_nr ) {
		...
		<div id="wpppfm-promotions-details-additional-attributes-tab-' . esc_attr( $promotion_nr ) . '" name="wpppfm-promotions-details-additional-attributes-tab-' . esc_attr( $promotion_nr ) . '" class="wppfm-panel wpppfm-promotions-details-panel hidden">
			<p class="wpppfm-input-field form-field wpppfm-text-input-row"><label for="wpppfm-promotion-display-dates-input-field-' . esc_attr( $promotion_nr ) . '">' . esc_html__( 'Display dates for promotion', 'wp-product-feed-manager' ) . '</label>
				<td>' . esc_html__( 'from ', 'wp-product-promotions-feed-manager' ) . '<input type="text" class="datepicker date-time-picker wpppfm-date-time-picker" name="wppfm-promotion-display-start-date" id="wpppfm-promotion-display-start-date-input-field-' . esc_attr( $promotion_nr ) . '" data-attribute-key="promotion_display_start_date" />'
				. esc_html__( ' till ', 'wp-product-promotions-feed-manager' ) . '<input type="text" class="datepicker date-time-picker wpppfm-date-time-picker" name="wppfm-promotion-display-end-date" id="wpppfm-promotion-display-end-date-input-field-' . esc_attr( $promotion_nr ) . '" data-attribute-key="promotion_display_end_date" /></td></tr>
